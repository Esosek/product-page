...
export default function Header() {
  return (
    <header className="flex items-center fixed h-16 bg-white gap-6 top-0 left-0 right-0 py-4 px-6 md:static md:gap-10 md:border-b-[1px] md:border-neutral-400 md:p-0">
      <a href="#">
